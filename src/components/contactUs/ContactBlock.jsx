...
export const ContactBlock = () => {
  return (
    <Contacts>
      <Block>
        <Name>{texts.contactBlock.namePhone}</Name>
        <PhoneWrapper>
          <Link href="tel:+380981234567" aria-label="make a call">
            <svg
            ...
            {texts.contactBlock.phone1}
          </Link>
          <Link href="tel:+380931234567" aria-label="make a call">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
            ...
            {texts.contactBlock.phone2}
          </Link>
        </PhoneWrapper>
      </Block>

      <Block>
        <Name>{texts.contactBlock.nameEmail}</Name>
        <Link href="mailto:office@ecosolution.com" aria-label="write an email">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
          ...
          {texts.contactBlock.email}
        </Link>
      </Block>

      <Block>
        <Name>{texts.contactBlock.nameAddress}</Name>
        <Address>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
          ...
          {texts.contactBlock.address}
        </Address>
      </Block>

      <Name>{texts.contactBlock.nameNetworks}</Name>
      <NetLinkBlack />
    </Contacts>
  );
};
